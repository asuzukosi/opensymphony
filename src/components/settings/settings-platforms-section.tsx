...
const wrapText = "min-w-0 max-w-full wrap-break-word wrap-anywhere";
        ...
        <ul className="grid gap-3 md:grid-cols-2">
          {isLoading
            ? Array.from({ length: 6 }, (_, index) => (
                <li
                  key={index}
                  className="flex min-w-0 items-center gap-3 rounded-md border border-border/60 p-3"
                >
                ...
                return (
                  ...
                  >
                    <IconTile variant="frame" size="default" aria-hidden="true">
                      <PlatformAvatar platformId={platform.id} size="sm" tooltip={false} />
                    </IconTile>
                    <div className="min-w-0 flex-1 space-y-1.5">
                      <div className="flex min-w-0 flex-wrap items-center gap-2">
                        ...
                        {installed ? (
                          ...
                          <Badge variant="outline" size="xs" radius="full" className="shrink-0">
                            Not installed
                          </Badge>
                        )}
                      </div>
