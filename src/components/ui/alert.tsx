...
const alertVariants = cva(
  [
    "relative w-full text-sm border has-[>svg]:grid-cols-[--spacing(3)_1fr] grid-cols-[0_1fr] grid gap-y-0.5 items-center [&>svg:not([class*=size-])]:size-4",
    "sm:**:data-[slot=alert-action]:has-[>[data-slot=alert-title]+[data-slot=alert-description]]:row-end-3",
