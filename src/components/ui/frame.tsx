  ...
  ],
  {
    variants: {
      variant: {
        ...
        inverse:
          "[--frame-panel-bg:color-mix(in_oklch,var(--color-muted)_40%,transparent)] border border-(--frame-border-color) bg-background bg-clip-padding",
      ...
      stacked: {
        ...
        false: [
          "[[data-slot=frame-panel]+[data-slot=frame-panel]]:*:data-[spacing=sm]:mt-0.5",
          "[[data-slot=frame-panel]+[data-slot=frame-panel]]:*:data-[spacing=default]:mt-1",
          "[[data-slot=frame-panel]+[data-slot=frame-panel]]:*:data-[spacing=lg]:mt-2",
        ],
      },
      dense: {
        ...
        true: "p-0 gap-0 border-(--frame-border-color) [--frame-panel-radius:var(--frame-radius)] **:data-[slot=frame-panel]:-mx-px **:data-[slot=frame-panel]:before:hidden [&_[data-slot=frame-panel]:last-child]:-mb-px [&:not(:has([data-slot=frame-panel-header]))_[data-slot=frame-panel]:is(:first-child)]:-mt-px",
        false: "",
      },
    },
    defaultVariants: {
  ...
  return (
    <div
      className={cn(
        ...
        "relative overflow-hidden rounded-(--frame-panel-radius) border border-(--frame-panel-border-color) bg-(--frame-panel-bg) bg-clip-padding shadow-2xs",
