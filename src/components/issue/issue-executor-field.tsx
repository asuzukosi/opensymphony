...
export function IssueExecutorField({
  value,
  onChange,
  platformIds,
  disabled = false,
  ...
  return (
    <PlatformPickerField
      label="Executor"
      description="Agent platform that runs this issue. One platform per issue."
      selected={selected}
      pickable={pickable}
      onSelect={onChange}
