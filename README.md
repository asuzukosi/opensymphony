...
| `useIssuePermissions(issueId)` | Pending permissions + resolve (issue sheet only) |
...
- Permissions UI is scoped to the issue detail sheet only — no global permission queue in the shell
